...
/**
 * NexusDevStudio — Admin Login
 * Autentificare admin via next-auth credentials provider.
 * Design imersiv glassmorphism mov/auriu, identic cu site-ul principal.
 *
 * Ruta: /login  (grupul (admin) este transparent în URL, vezi middleware.ts)
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setError("A apărut o eroare neașteptată. Verifică conexiunea și încearcă din nou.");
        setLoading(false);
      }
    },
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-tertiary text-sm mt-1">
            Autentifică-te pentru a gestiona site-ul
          </p>
        </div>
          ...
          {success ? (
            ...
            <div className="text-center py-6 animate-scale-in">
              ...
              <p className="text-text-secondary text-sm">
                Ești redirecționat către panoul de administrare...
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="nexusdevstudio@admin.ro"
                />
              </div>
              ...
              <p className="text-center text-xs text-text-tertiary">
                Acces restricționat • NexusDevStudio Admin
              </p>
            </form>
          )}
        </div>
